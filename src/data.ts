import type { Project, Experience, WorkflowStep, TechCategory } from "./types";

export const aiTools: readonly string[] = ["GitHub Copilot","ChatGPT","Claude","Amazon Q","OpenAI Codex"];
...
export const skillGroups: readonly TechCategory[] = [
